<table width="100%" cellspacing="0" border="0">
  ...
  <tr>
      <form method="GET" action="?p=dragoncoinshop">
        <input type="hidden" name="p" value="dragoncoinshop">
...
<table width="100%" cellspacing="0" border="0">
  ...
  <tr>
    ...
    <td class="borderT" style ="boxSchatten" align="center"><?php echo number_format($item->GetDragonCoins(), 0, ',', '.'); ?> Coins</td>
    <td class="borderT" style ="boxSchatten"> 
      <button onclick="OpenPopupPage('Item Kaufen','shop/buycoins.php?item=<?php echo $item->GetID(); if(isset($_GET['itemname'])) echo '&itemname='.$_GET['itemname']; if(isset($_GET['itemcategory'])) echo '&itemcategory='.$_GET['itemcategory']; ?>')">
      Kaufen
      </button>
    </td>
    </form>
